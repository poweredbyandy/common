...
class ResConfigSettings(models.TransientModel):
    ...
    pba_final_cost_formula = fields.Text(
        ...
        "• pba_cost_freight, pba_cost_tariff, pba_cost_operative, pba_cost_nationalization (importes = pba_last_cost × %)\n"
        "• pba_cost_*_percent por cada bloque (freight, tariff, operative, nationalization)\n"
        "• En fórmulas antiguas, pba_cost_*_operation_total sigue existiendo como alias de pba_last_cost.\n"
