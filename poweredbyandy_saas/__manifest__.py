...
{
    "name": "Powered By Andy - SaaS",
    "icon": "/poweredbyandy_saas/static/description/icon.png",
    "summary": "Instala todos los módulos base necesarios para el SaaS de Venezuela",
    "version": "18.0.1.0.0",
    ...
    "assets": {
        "web.assets_backend": [
            "poweredbyandy_saas/static/src/xml/apps_menu_watermark.xml",
            "poweredbyandy_saas/static/src/scss/apps_menu_watermark.scss",
        ],
    },
    "depends": [
        "account",
