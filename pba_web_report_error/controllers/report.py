...
class PbaWebReportController(WebReportController):
    def _pba_report_http_error_response(self, exception, reportname):
    ...
    def report_routes(self, reportname, docids=None, converter=None, **data):
        try:
            ...
            raise werkzeug.exceptions.InternalServerError(
                response=self._pba_report_http_error_response(exc, reportname)
            ) from exc
