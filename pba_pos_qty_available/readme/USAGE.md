...
5. Products at quantity 0 cannot be added. Increasing a line above the
   remaining available quantity is blocked. Paying / invoicing an order that
   already contains the last available unit still works.
6. Open POS terminals with the option enabled receive live updates when stock
