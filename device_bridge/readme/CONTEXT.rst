Hardware such as ESC/POS printers is often attached to a single workstation.
Operators still need to print or talk to that device from another tablet, POS
